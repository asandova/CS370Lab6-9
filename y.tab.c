...
{
       0,     0,     3,     5,     8,    10,    11,    13,    15,    20,
      24,    25,    27,    29,    36,    38,    40,    43,    46,    47,
      51,    55,    56,    61,    64,    65,    66,    69,    71,    73,
      75,    77,    79,    81,    83,    85,    88,    90,    94,   101,
     102,   105,   111,   114,   117,   119,   123,   127,   129,   132,
     136,   137,   139,   143,   145,   147,   149,   151,   153,   155,
     157,   161,   163,   165,   167,   171,   173,   175,   179,   181,
     183,   185,   190,   192,   193,   196,   199
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      39,     0,    -1,    40,    -1,    42,    41,    -1,    40,    -1,
      -1,    43,    -1,    46,    -1,    45,    20,    44,    29,    -1,
      30,     3,    31,    -1,    -1,     4,    -1,     5,    -1,    45,
      20,    32,    47,    33,    52,    -1,     5,    -1,    48,    -1,
      50,    49,    -1,    34,    48,    -1,    -1,    45,    20,    51,
      -1,    30,     3,    31,    -1,    -1,    35,    53,    54,    36,
      -1,    43,    53,    -1,    -1,    -1,    55,    54,    -1,    56,
      -1,    52,    -1,    58,    -1,    60,    -1,    57,    -1,    61,
      -1,    63,    -1,    64,    -1,    65,    29,    -1,    29,    -1,
      66,    37,    56,    -1,     7,    32,    65,    33,    55,    59,
      -1,    -1,     9,    55,    -1,     6,    32,    65,    33,    55,
      -1,    13,    62,    -1,    65,    29,    -1,    29,    -1,    10,
      66,    29,    -1,    11,    65,    29,    -1,    68,    -1,    20,
      67,    -1,    30,    65,    31,    -1,    -1,    70,    -1,    68,
      69,    70,    -1,    14,    -1,    18,    -1,    19,    -1,    15,
      -1,    16,    -1,    17,    -1,    72,    -1,    70,    71,    72,
      -1,    23,    -1,    24,    -1,    74,    -1,    72,    73,    74,
      -1,    25,    -1,    26,    -1,    32,    65,    33,    -1,     3,
      -1,    66,    -1,    75,    -1,    20,    32,    76,    33,    -1,
      77,    -1,    -1,    65,    78,    -1,    34,    77,    -1,    -1
};
...
static const char *const yytname[] =
{
  ...
  "LT", "GT", "ID", "'|'", "'&'", "'+'", "'-'", "'*'", "'/'", "'%'",
  "UMINUS", "';'", "'['", "']'", "'('", "')'", "','", "'{'", "'}'", "'='",
  "$accept", "P", "DL", "DLNEXT", "DEC", "VARDEC", "VARISARRAYDEC",
  "typespec", "FUNDEC", "params", "paramlist", "PARAMNEXT", "param",
  "PARAMISARRAY", "compoundstmt", "localdeclarations", "statementlist",
  "statement", "expressionstmt", "assignmentstmt", "selectionstmt",
  "IFELSE", "iterationstmt", "returnstmt", "RETVAL", "readstmt",
  "writestmt", "expression", "var", "ISARRAY", "simpleexpression", "relop",
  "additiveexpression", "addop", "term", "multop", "factor", "call",
  "args", "arglist", "ARGNEXT", YY_NULL
      35,    83,    84,    85,    86,    87,    88,     1,    17,    90,
      91,    24,   -14,    93,    94,    25,    30,    26,    33,    28,
     102,    37,    39,   112,    60,    60,    13,    66,    68,    67,
      79,    75,   105,    60,    81,    82,    98,   110,    99,   100,
     113,   119,    10,    32,   111,   115,    31,    38,   107,   106,
     118,    80,   108,     0,     0,     0,   109
};
...
{
      36,    44,    45,     0,    30,    48,    32,    43,     3,     3,
       3,     3,     6,     7,    30,    51,    10,    11,    34,    13,
     110,   111,    20,    66,    67,    20,    20,    20,    20,   119,
      14,     3,    75,    76,    29,    29,    29,    32,    32,    32,
      32,    35,    26,    30,    29,    32,    30,     4,     5,    31,
      34,    14,    15,    16,    17,    18,    19,     4,     5,    23,
      24,    20,    33,    25,    26,    33,    35,    34,     3,    30,
     113,    31,    20,    31,   110,   111,    30,    32,    20,    32,
      36,    30,    33,   119,    29,    37,    29,    33,    29,    29,
      34,     9,     5,    26,    33,    33,    25,    34,    89,    82,
     113,    51,    92,    -1,    -1,    -1,    95
};
...
{
       0,     4,     5,    39,    40,    42,    43,    45,    46,     0,
      40,    41,    20,    30,    32,    44,     3,     5,    45,    47,
      48,    50,    29,    31,    20,    33,    34,    49,    30,    51,
      35,    52,    48,     3,    43,    45,    53,    31,    53,    20,
       3,     6,     7,    10,    11,    13,    20,    29,    32,    52,
      54,    55,    56,    57,    58,    60,    61,    63,    64,    65,
      66,    68,    70,    72,    74,    75,    32,    32,    20,    66,
      65,    66,    29,    62,    65,    30,    32,    67,    65,    36,
      54,    29,    37,    14,    15,    16,    17,    18,    19,    69,
      23,    24,    71,    25,    26,    73,    65,    65,    29,    29,
      29,    65,    65,    76,    77,    33,    56,    70,    72,    74,
      33,    33,    31,    34,    78,    33,    55,    55,    77,     9,
      59,    55
};
...
#line 103 "lab6.y"
	...
	*/
	...
	(yyval.node)->datatype=(yyvsp[(1) - (4)].operator);
	(yyval.node)->name=(yyvsp[(2) - (4)].string); /* this changes to symbol table*/
...
#line 163 "lab6.y"
    {
		...
		(yyval.node)->datatype = (yyvsp[(1) - (3)].operator);
		(yyval.node)->name = (yyvsp[(2) - (3)].string);
		(yyval.node)->value = (yyvsp[(3) - (3)].value);
		//...
	}
    break;
...
#line 224 "lab6.y"
    {
			...
			(yyval.node)->s2=(yyvsp[(5) - (6)].node);
			(yyval.node)->s3=(yyvsp[(6) - (6)].node);
                	}
    break;
...
#line 274 "lab6.y"
    {
		...
		(yyval.node)->name = (yyvsp[(1) - (2)].string);
		(yyval.node)->s1 = (yyvsp[(2) - (2)].node);		
	}
    break;
